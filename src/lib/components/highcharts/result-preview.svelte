...
<pre class="shiki css-variables" style="background-color:var(--code-preview-background);color:var(--code-preview-foreground)" tabindex="0"><code><span class="line"><span style="color:var(--code-preview-token-keyword);font-style:italic">import</span><span style="color:var(--code-preview-foreground)"> openmeteo_requests</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:var(--code-preview-token-comment)"># Setup the Open-Meteo API client with cache and retry on error</span></span>
<span class="line"><span style="color:var(--code-preview-foreground)">cache_session </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-foreground)"> requests_cache</span><span style="color:var(--code-preview-token-punctuation)">.</span><span style="color:var(--code-preview-token-function)">CachedSession</span><span style="color:var(--code-preview-token-punctuation)">(</span><span style="color:var(--code-preview-token-string-expression)">'.cache'</span><span style="color:var(--code-preview-token-punctuation)">, expire_after </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-constant)"> 3600</span><span style="color:var(--code-preview-token-punctuation)">)</span></span>
<span class="line"><span style="color:var(--code-preview-foreground)">retry_session </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-function)"> retry</span><span style="color:var(--code-preview-token-punctuation)">(cache_session, retries </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-constant)"> 5</span><span style="color:var(--code-preview-token-punctuation)">, backoff_factor </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-constant)"> 0.2</span><span style="color:var(--code-preview-token-punctuation)">)</span></span>
<span class="line"><span style="color:var(--code-preview-foreground)">openmeteo </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-foreground)"> openmeteo_requests</span><span style="color:var(--code-preview-token-punctuation)">.</span><span style="color:var(--code-preview-token-function)">Client</span><span style="color:var(--code-preview-token-punctuation)">(session </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-punctuation)"> retry_session)</span></span>
<span class="line"></span>
<span class="line"><span style="color:var(--code-preview-token-comment)"># Make sure all required weather variables are listed here</span></span>
<span class="line"><span style="color:var(--code-preview-token-comment)"># The order of variables in hourly or daily is important to assign them correctly below</span></span>
<span class="line"><span style="color:var(--code-preview-foreground)">url </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-string-expression)"> "https://api.open-meteo.com/v1/forecast"</span></span>
<span class="line"><span style="color:var(--code-preview-foreground)">params </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-punctuation)"> {</span></span>
<span class="line"><span style="color:var(--code-preview-token-string-expression)">	"latitude"</span><span style="color:var(--code-preview-token-punctuation)">:</span><span style="color:var(--code-preview-token-constant)"> 52.52</span><span style="color:var(--code-preview-token-punctuation)">,</span></span>
<span class="line"><span style="color:var(--code-preview-token-string-expression)">	"longitude"</span><span style="color:var(--code-preview-token-punctuation)">:</span><span style="color:var(--code-preview-token-constant)"> 13.41</span><span style="color:var(--code-preview-token-punctuation)">,</span></span>
<span class="line"><span style="color:var(--code-preview-token-string-expression)">	"daily"</span><span style="color:var(--code-preview-token-punctuation)">:</span><span style="color:var(--code-preview-foreground)"> [</span><span style="color:var(--code-preview-token-string-expression)">"weather_code"</span><span style="color:var(--code-preview-token-punctuation)">,</span><span style="color:var(--code-preview-token-string-expression)"> "sunrise"</span><span style="color:var(--code-preview-foreground)">]</span><span style="color:var(--code-preview-token-punctuation)">,</span></span>
<span class="line"><span style="color:var(--code-preview-token-string-expression)">	"hourly"</span><span style="color:var(--code-preview-token-punctuation)">:</span><span style="color:var(--code-preview-token-string-expression)"> "temperature_2m"</span><span style="color:var(--code-preview-token-punctuation)">,</span></span>
<span class="line"><span style="color:var(--code-preview-token-string-expression)">	"current"</span><span style="color:var(--code-preview-token-punctuation)">:</span><span style="color:var(--code-preview-token-string-expression)"> "temperature_2m"</span><span style="color:var(--code-preview-token-punctuation)">,</span></span>
<span class="line"><span style="color:var(--code-preview-token-punctuation)">}</span></span>
<span class="line"><span style="color:var(--code-preview-foreground)">responses </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-foreground)"> openmeteo</span><span style="color:var(--code-preview-token-punctuation)">.</span><span style="color:var(--code-preview-token-function)">weather_api</span><span style="color:var(--code-preview-token-punctuation)">(url, params</span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-punctuation)">params)</span></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"><span style="color:var(--code-preview-token-comment)"># Current values. The order of variables needs to be the same as requested.</span></span>
<span class="line"><span style="color:var(--code-preview-foreground)">current </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-foreground)"> response</span><span style="color:var(--code-preview-token-punctuation)">.</span><span style="color:var(--code-preview-token-function)">Current</span><span style="color:var(--code-preview-token-punctuation)">()</span></span>
<span class="line"><span style="color:var(--code-preview-foreground)">current_temperature_2m </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-foreground)"> current</span><span style="color:var(--code-preview-token-punctuation)">.</span><span style="color:var(--code-preview-token-function)">Variables</span><span style="color:var(--code-preview-token-punctuation)">(</span><span style="color:var(--code-preview-token-constant)">0</span><span style="color:var(--code-preview-token-punctuation)">).</span><span style="color:var(--code-preview-token-function)">Value</span><span style="color:var(--code-preview-token-punctuation)">()</span></span>
<span class="line"></span>
<span class="line"><span style="color:var(--code-preview-token-function)">print</span><span style="color:var(--code-preview-token-punctuation)">(</span><span style="color:var(--code-preview-token-keyword)">f</span><span style="color:var(--code-preview-token-string-expression)">"Current time </span><span style="color:var(--code-preview-token-constant)">{</span><span style="color:var(--code-preview-token-punctuation)">current.</span><span style="color:var(--code-preview-token-function)">Time</span><span style="color:var(--code-preview-token-punctuation)">()</span><span style="color:var(--code-preview-token-constant)">}</span><span style="color:var(--code-preview-token-string-expression)">"</span><span style="color:var(--code-preview-token-punctuation)">)</span></span>
<span class="line"><span style="color:var(--code-preview-token-function)">print</span><span style="color:var(--code-preview-token-punctuation)">(</span><span style="color:var(--code-preview-token-keyword)">f</span><span style="color:var(--code-preview-token-string-expression)">"Current temperature_2m </span><span style="color:var(--code-preview-token-constant)">{</span><span style="color:var(--code-preview-token-punctuation)">current_temperature_2m</span><span style="color:var(--code-preview-token-constant)">}</span><span style="color:var(--code-preview-token-string-expression)">"</span><span style="color:var(--code-preview-token-punctuation)">)</span></span>
<span class="line"></span>
<span class="line"><span style="color:var(--code-preview-token-comment)"># Process hourly data. The order of variables needs to be the same as requested.</span></span>
<span class="line"><span style="color:var(--code-preview-foreground)">hourly </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-foreground)"> response</span><span style="color:var(--code-preview-token-punctuation)">.</span><span style="color:var(--code-preview-token-function)">Hourly</span><span style="color:var(--code-preview-token-punctuation)">()</span></span>
<span class="line"><span style="color:var(--code-preview-foreground)">hourly_temperature_2m </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-foreground)"> hourly</span><span style="color:var(--code-preview-token-punctuation)">.</span><span style="color:var(--code-preview-token-function)">Variables</span><span style="color:var(--code-preview-token-punctuation)">(</span><span style="color:var(--code-preview-token-constant)">0</span><span style="color:var(--code-preview-token-punctuation)">).</span><span style="color:var(--code-preview-token-function)">ValuesAsNumpy</span><span style="color:var(--code-preview-token-punctuation)">()</span></span>
<span class="line"></span>
<span class="line"><span style="color:var(--code-preview-foreground)">hourly_data </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-punctuation)"> {</span><span style="color:var(--code-preview-token-string-expression)">"date"</span><span style="color:var(--code-preview-token-punctuation)">:</span><span style="color:var(--code-preview-foreground)"> pd</span><span style="color:var(--code-preview-token-punctuation)">.</span><span style="color:var(--code-preview-token-function)">date_range</span><span style="color:var(--code-preview-token-punctuation)">(</span></span>
<span class="line"><span style="color:var(--code-preview-token-punctuation)">	start </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-punctuation)"> pd.</span><span style="color:var(--code-preview-token-function)">to_datetime</span><span style="color:var(--code-preview-token-punctuation)">(hourly.</span><span style="color:var(--code-preview-token-function)">Time</span><span style="color:var(--code-preview-token-punctuation)">(), unit </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-string-expression)"> "s"</span><span style="color:var(--code-preview-token-punctuation)">, utc </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-constant)"> True</span><span style="color:var(--code-preview-token-punctuation)">),</span></span>
<span class="line"><span style="color:var(--code-preview-token-punctuation)">	end </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-punctuation)"> pd.</span><span style="color:var(--code-preview-token-function)">to_datetime</span><span style="color:var(--code-preview-token-punctuation)">(hourly.</span><span style="color:var(--code-preview-token-function)">TimeEnd</span><span style="color:var(--code-preview-token-punctuation)">(), unit </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-string-expression)"> "s"</span><span style="color:var(--code-preview-token-punctuation)">, utc </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-constant)"> True</span><span style="color:var(--code-preview-token-punctuation)">),</span></span>
<span class="line"><span style="color:var(--code-preview-token-punctuation)">	freq </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-punctuation)"> pd.</span><span style="color:var(--code-preview-token-function)">Timedelta</span><span style="color:var(--code-preview-token-punctuation)">(seconds </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-punctuation)"> hourly.</span><span style="color:var(--code-preview-token-function)">Interval</span><span style="color:var(--code-preview-token-punctuation)">()),</span></span>
<span class="line"><span style="color:var(--code-preview-token-punctuation)">	inclusive </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-string-expression)"> "left"</span></span>
<span class="line"><span style="color:var(--code-preview-token-punctuation)">)}</span></span>
<span class="line"></span>
<span class="line"><span style="color:var(--code-preview-foreground)">hourly_data</span><span style="color:var(--code-preview-token-punctuation)">[</span><span style="color:var(--code-preview-token-string-expression)">"temperature_2m"</span><span style="color:var(--code-preview-token-punctuation)">]</span><span style="color:var(--code-preview-token-keyword)"> =</span><span style="color:var(--code-preview-foreground)"> hourly_temperature_2m</span></span>
<span class="line"></span>
<span class="line"><span style="color:var(--code-preview-foreground)">hourly_dataframe </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-foreground)"> pd</span><span style="color:var(--code-preview-token-punctuation)">.</span><span style="color:var(--code-preview-token-function)">DataFrame</span><span style="color:var(--code-preview-token-punctuation)">(data </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-punctuation)"> hourly_data)</span></span>
<span class="line"><span style="color:var(--code-preview-token-function)">print</span><span style="color:var(--code-preview-token-punctuation)">(hourly_dataframe)</span></span>
<span class="line"></span>
<span class="line"><span style="color:var(--code-preview-token-comment)"># Process daily data. The order of variables needs to be the same as requested.</span></span>
<span class="line"><span style="color:var(--code-preview-foreground)">daily </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-foreground)"> response</span><span style="color:var(--code-preview-token-punctuation)">.</span><span style="color:var(--code-preview-token-function)">Daily</span><span style="color:var(--code-preview-token-punctuation)">()</span></span>
<span class="line"><span style="color:var(--code-preview-foreground)">daily_weather_code </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-foreground)"> daily</span><span style="color:var(--code-preview-token-punctuation)">.</span><span style="color:var(--code-preview-token-function)">Variables</span><span style="color:var(--code-preview-token-punctuation)">(</span><span style="color:var(--code-preview-token-constant)">0</span><span style="color:var(--code-preview-token-punctuation)">).</span><span style="color:var(--code-preview-token-function)">ValuesAsNumpy</span><span style="color:var(--code-preview-token-punctuation)">()</span></span>
<span class="line"><span style="color:var(--code-preview-foreground)">daily_sunrise </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-foreground)"> daily</span><span style="color:var(--code-preview-token-punctuation)">.</span><span style="color:var(--code-preview-token-function)">Variables</span><span style="color:var(--code-preview-token-punctuation)">(</span><span style="color:var(--code-preview-token-constant)">1</span><span style="color:var(--code-preview-token-punctuation)">).</span><span style="color:var(--code-preview-token-function)">ValuesInt64AsNumpy</span><span style="color:var(--code-preview-token-punctuation)">()</span></span>
<span class="line"></span>
<span class="line"><span style="color:var(--code-preview-foreground)">daily_data </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-punctuation)"> {</span><span style="color:var(--code-preview-token-string-expression)">"date"</span><span style="color:var(--code-preview-token-punctuation)">:</span><span style="color:var(--code-preview-foreground)"> pd</span><span style="color:var(--code-preview-token-punctuation)">.</span><span style="color:var(--code-preview-token-function)">date_range</span><span style="color:var(--code-preview-token-punctuation)">(</span></span>
<span class="line"><span style="color:var(--code-preview-token-punctuation)">	start </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-punctuation)"> pd.</span><span style="color:var(--code-preview-token-function)">to_datetime</span><span style="color:var(--code-preview-token-punctuation)">(daily.</span><span style="color:var(--code-preview-token-function)">Time</span><span style="color:var(--code-preview-token-punctuation)">(), unit </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-string-expression)"> "s"</span><span style="color:var(--code-preview-token-punctuation)">, utc </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-constant)"> True</span><span style="color:var(--code-preview-token-punctuation)">),</span></span>
<span class="line"><span style="color:var(--code-preview-token-punctuation)">	end </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-punctuation)"> pd.</span><span style="color:var(--code-preview-token-function)">to_datetime</span><span style="color:var(--code-preview-token-punctuation)">(daily.</span><span style="color:var(--code-preview-token-function)">TimeEnd</span><span style="color:var(--code-preview-token-punctuation)">(), unit </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-string-expression)"> "s"</span><span style="color:var(--code-preview-token-punctuation)">, utc </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-constant)"> True</span><span style="color:var(--code-preview-token-punctuation)">),</span></span>
<span class="line"><span style="color:var(--code-preview-token-punctuation)">	freq </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-punctuation)"> pd.</span><span style="color:var(--code-preview-token-function)">Timedelta</span><span style="color:var(--code-preview-token-punctuation)">(seconds </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-punctuation)"> daily.</span><span style="color:var(--code-preview-token-function)">Interval</span><span style="color:var(--code-preview-token-punctuation)">()),</span></span>
<span class="line"><span style="color:var(--code-preview-token-punctuation)">	inclusive </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-string-expression)"> "left"</span></span>
<span class="line"><span style="color:var(--code-preview-token-punctuation)">)}</span></span>
<span class="line"></span>
<span class="line"><span style="color:var(--code-preview-foreground)">daily_data</span><span style="color:var(--code-preview-token-punctuation)">[</span><span style="color:var(--code-preview-token-string-expression)">"weather_code"</span><span style="color:var(--code-preview-token-punctuation)">]</span><span style="color:var(--code-preview-token-keyword)"> =</span><span style="color:var(--code-preview-foreground)"> daily_weather_code</span></span>
<span class="line"><span style="color:var(--code-preview-foreground)">daily_data</span><span style="color:var(--code-preview-token-punctuation)">[</span><span style="color:var(--code-preview-token-string-expression)">"sunrise"</span><span style="color:var(--code-preview-token-punctuation)">]</span><span style="color:var(--code-preview-token-keyword)"> =</span><span style="color:var(--code-preview-foreground)"> daily_sunrise</span></span>
<span class="line"></span>
<span class="line"><span style="color:var(--code-preview-foreground)">daily_dataframe </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-foreground)"> pd</span><span style="color:var(--code-preview-token-punctuation)">.</span><span style="color:var(--code-preview-token-function)">DataFrame</span><span style="color:var(--code-preview-token-punctuation)">(data </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-punctuation)"> daily_data)</span></span>
<span class="line"><span style="color:var(--code-preview-token-function)">print</span><span style="color:var(--code-preview-token-punctuation)">(daily_dataframe)</span></span></code>
</pre>`);
</script>
