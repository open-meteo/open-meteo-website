<script lang="ts">
	...
	let pythonCode = $derived.by(() => {
		let daily = parsedParams.daily;
		let hourly = parsedParams.hourly;
		let models = parsedParams.models;
		let current = parsedParams.current;
...
<span class="line"><span style="color:var(--code-preview-token-string-expression)">	<span style="color:var(--code-preview-token-punctuation-mark)">"</span>latitude<span style="color:var(--code-preview-token-punctuation-mark)">"</span></span><span style="color:var(--code-preview-token-punctuation-mark)">:</span><span style="color:var(--code-preview-token-constant)"> ${parsedParams.latitude.constructor === Array ? '<span style="color:var(--code-preview-token-bracket)">[</span>' + parsedParams.latitude.join('<span style="color:var(--code-preview-token-punctuation-mark)">, </span>') + '<span style="color:var(--code-preview-token-bracket)">]</span>' : parsedParams.latitude}</span><span style="color:var(--code-preview-token-punctuation-mark)">,</span></span>
<span class="line"><span style="color:var(--code-preview-token-string-expression)">	<span style="color:var(--code-preview-token-punctuation-mark)">"</span>longitude<span style="color:var(--code-preview-token-punctuation-mark)">"</span></span><span style="color:var(--code-preview-token-punctuation-mark)">:</span><span style="color:var(--code-preview-token-constant)"> ${parsedParams.longitude.constructor === Array ? '<span style="color:var(--code-preview-token-bracket)">[</span>' + parsedParams.longitude.join('<span style="color:var(--code-preview-token-punctuation-mark)">, </span>') + '<span style="color:var(--code-preview-token-bracket)">]</span>' : parsedParams.longitude}</span><span style="color:var(--code-preview-token-punctuation-mark)">,</span></span>`;
		if (daily) {
			c += `
<span class="line"><span style="color:var(--code-preview-token-string-expression)">	<span style="color:var(--code-preview-token-punctuation-mark)">"</span>daily<span style="color:var(--code-preview-token-punctuation-mark)">"</span></span><span style="color:var(--code-preview-token-punctuation-mark)">:</span> ${parsedParams.daily.constructor === Array ? '<span style="color:var(--code-preview-token-bracket)">[<span style="color:var(--code-preview-token-punctuation-mark)">"</span></span><span style="color:var(--code-preview-token-string-expression)">' + parsedParams.daily.join('</span><span style="color:var(--code-preview-token-punctuation-mark)">"</span><span style="color:var(--code-preview-token-punctuation-mark)">, <span style="color:var(--code-preview-token-punctuation-mark)">"</span></span><span style="color:var(--code-preview-token-string-expression)">') + '</span><span style="color:var(--code-preview-token-punctuation-mark)">"</span><span style="color:var(--code-preview-token-bracket)">]</span>' : '<span style="color:var(--code-preview-token-punctuation-mark)">"</span><span style="color:var(--code-preview-token-string-expression)">' + parsedParams.daily + '</span><span style="color:var(--code-preview-token-punctuation-mark)">"</span>'}<span style="color:var(--code-preview-token-punctuation-mark)">,</span>`;
		}
		if (hourly) {
			c += `
<span class="line"><span style="color:var(--code-preview-token-string-expression)">	<span style="color:var(--code-preview-token-punctuation-mark)">"</span>hourly<span style="color:var(--code-preview-token-punctuation-mark)">"</span></span><span style="color:var(--code-preview-token-punctuation-mark)">:</span> ${parsedParams.hourly.constructor === Array ? '<span style="color:var(--code-preview-token-bracket)">[<span style="color:var(--code-preview-token-punctuation-mark)">"</span></span><span style="color:var(--code-preview-token-string-expression)">' + parsedParams.hourly.join('</span><span style="color:var(--code-preview-token-punctuation-mark)">"</span><span style="color:var(--code-preview-token-punctuation-mark)">, <span style="color:var(--code-preview-token-punctuation-mark)">"</span></span><span style="color:var(--code-preview-token-string-expression)">') + '</span><span style="color:var(--code-preview-token-punctuation-mark)">"</span><span style="color:var(--code-preview-token-bracket)">]</span>' : '<span style="color:var(--code-preview-token-punctuation-mark)">"</span><span style="color:var(--code-preview-token-string-expression)">' + parsedParams.hourly + '</span><span style="color:var(--code-preview-token-punctuation-mark)">"</span>'}<span style="color:var(--code-preview-token-punctuation-mark)">,</span>`;
		}
		if (models) {
			c += `
<span class="line"><span style="color:var(--code-preview-token-string-expression)">	<span style="color:var(--code-preview-token-punctuation-mark)">"</span>models<span style="color:var(--code-preview-token-punctuation-mark)">"</span></span><span style="color:var(--code-preview-token-punctuation-mark)">:</span> ${parsedParams.models.constructor === Array ? '<span style="color:var(--code-preview-token-bracket)">[<span style="color:var(--code-preview-token-punctuation-mark)">"</span></span><span style="color:var(--code-preview-token-string-expression)">' + parsedParams.models.join('</span><span style="color:var(--code-preview-token-punctuation-mark)">"</span><span style="color:var(--code-preview-token-punctuation-mark)">, <span style="color:var(--code-preview-token-punctuation-mark)">"</span></span><span style="color:var(--code-preview-token-string-expression)">') + '</span><span style="color:var(--code-preview-token-punctuation-mark)">"</span><span style="color:var(--code-preview-token-bracket)">]</span>' : '<span style="color:var(--code-preview-token-punctuation-mark)">"</span><span style="color:var(--code-preview-token-string-expression)">' + parsedParams.models + '</span><span style="color:var(--code-preview-token-punctuation-mark)">"</span>'}<span style="color:var(--code-preview-token-punctuation-mark)">,</span>`;
		}
		if (current) {
			c += `
<span class="line"><span style="color:var(--code-preview-token-string-expression)">	<span style="color:var(--code-preview-token-punctuation-mark)">"</span>current<span style="color:var(--code-preview-token-punctuation-mark)">"</span></span><span style="color:var(--code-preview-token-punctuation-mark)">:</span> ${parsedParams.current.constructor === Array ? '<span style="color:var(--code-preview-token-bracket)">[<span style="color:var(--code-preview-token-punctuation-mark)">"</span></span><span style="color:var(--code-preview-token-string-expression)">' + parsedParams.current.join('</span><span style="color:var(--code-preview-token-punctuation-mark)">"</span><span style="color:var(--code-preview-token-punctuation-mark)">, <span style="color:var(--code-preview-token-punctuation-mark)">"</span></span><span style="color:var(--code-preview-token-string-expression)">') + '</span><span style="color:var(--code-preview-token-punctuation-mark)">"</span><span style="color:var(--code-preview-token-bracket)">]</span>' : '<span style="color:var(--code-preview-token-punctuation-mark)">"</span><span style="color:var(--code-preview-token-string-expression)">' + parsedParams.current + '</span><span style="color:var(--code-preview-token-punctuation-mark)">"</span>'}<span style="color:var(--code-preview-token-punctuation-mark)">,</span>`;
		}
		c += `
...
<span class="line"></span>`;
		if (processMultipleLocations) {
			c +=
				`
<span class="line"><span style="color:var(--code-preview-token-comment)"># Process ` +
				(numberOfLocations ? `${numberOfLocations} locations` : '1 location') +
				(numberOfModels ? ` and ${numberOfModels} models` : '') +
				`</span></span>
<span class="line"><span style="color:var(--code-preview-token-keyword)">for </span><span style="color:var(--code-preview-foreground)">response </span><span style="color:var(--code-preview-token-keyword)">in</span><span style="color:var(--code-preview-foreground)"> responses</span><span style="color:var(--code-preview-token-punctuation-mark)">:</span></span>`;
		} else {
			c += `
...
${p ? '\t' : ''}<span class="line"><span style="color:var(--code-preview-token-comment)"># Current values. The order of variables needs to be the same as requested.</span></span>
...
${p ? '\t' : ''}<span class="line"></span>`;
		...
		if (daily) {
			c += `
${p ? '\t' : ''}<span class="line"></span>
${p ? '\t' : ''}<span class="line"><span style="color:var(--code-preview-token-comment)"># Process daily data. The order of variables needs to be the same as requested.</span></span>
${p ? '\t' : ''}<span class="line"><span style="color:var(--code-preview-foreground)">daily </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-foreground)"> response</span><span style="color:var(--code-preview-token-punctuation-mark)">.</span><span style="color:var(--code-preview-token-function)">Daily</span><span style="color:var(--code-preview-token-bracket)">()</span></span>`;
			if (daily.constructor === Array) {
				for (const [ind, d] of daily.entries()) {
					c += `
${p ? '\t' : ''}<span class="line"><span style="color:var(--code-preview-foreground)">daily_${d} </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-foreground)"> daily</span><span style="color:var(--code-preview-token-punctuation-mark)">.</span><span style="color:var(--code-preview-token-function)">Variables</span><span style="color:var(--code-preview-token-bracket)">(</span><span style="color:var(--code-preview-token-constant)">${ind}</span><span style="color:var(--code-preview-token-bracket)">).</span><span style="color:var(--code-preview-token-function)">${int64Variables.includes(d) ? 'ValuesInt64AsNumpy' : 'ValuesAsNumpy'}</span><span style="color:var(--code-preview-token-bracket)">()</span></span>`;
				}
			} else {
				c += `
${p ? '\t' : ''}<span class="line"><span style="color:var(--code-preview-foreground)">daily_${daily} </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-foreground)"> daily</span><span style="color:var(--code-preview-token-punctuation-mark)">.</span><span style="color:var(--code-preview-token-function)">Variables</span><span style="color:var(--code-preview-token-bracket)">(</span><span style="color:var(--code-preview-token-constant)">0</span><span style="color:var(--code-preview-token-bracket)">).</span><span style="color:var(--code-preview-token-function)">${int64Variables.includes(d) ? 'ValuesInt64AsNumpy' : 'ValuesAsNumpy'}</span><span style="color:var(--code-preview-token-bracket)">()</span></span>`;
			}
			c += `
${p ? '\t' : ''}<span class="line"></span>
${p ? '\t' : ''}<span class="line"><span style="color:var(--code-preview-foreground)">daily_data </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-punctuation-mark)"> {</span><span style="color:var(--code-preview-token-punctuation-mark)">"</span><span style="color:var(--code-preview-token-string-expression)">date<span style="color:var(--code-preview-token-punctuation-mark)">"</span></span><span style="color:var(--code-preview-token-punctuation-mark)">:</span><span style="color:var(--code-preview-foreground)"> pd</span><span style="color:var(--code-preview-token-punctuation-mark)">.</span><span style="color:var(--code-preview-token-function)">date_range</span><span style="color:var(--code-preview-token-bracket)">(</span></span>
${p ? '\t' : ''}<span class="line"><span style="color:var(--code-preview-foreground);font-style:italic;">	start </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-punctuation)"> pd.</span><span style="color:var(--code-preview-token-function)">to_datetime</span><span style="color:var(--code-preview-token-bracket)">(<span style="color:var(--code-preview-token-function)">daily</span>.</span><span style="color:var(--code-preview-token-function)">Time</span><span style="color:var(--code-preview-token-bracket)">(), <span style="color:var(--code-preview-foreground);font-style:italic;">unit</span> </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-punctuation-mark)"> "</span><span style="color:var(--code-preview-token-string-expression)">s</span><span style="color:var(--code-preview-token-punctuation-mark)">"</span></span><span style="color:var(--code-preview-token-punctuation-mark)">, <span style="color:var(--code-preview-foreground);font-style:italic;">utc</span> </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-constant)"> True</span><span style="color:var(--code-preview-token-bracket)">),</span></span>
${p ? '\t' : ''}<span class="line"><span style="color:var(--code-preview-foreground);font-style:italic;">	end </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-punctuation)"> pd.</span><span style="color:var(--code-preview-token-function)">to_datetime</span><span style="color:var(--code-preview-token-bracket)">(<span style="color:var(--code-preview-token-function)">daily</span>.</span><span style="color:var(--code-preview-token-function)">TimeEnd</span><span style="color:var(--code-preview-token-bracket)">(), <span style="color:var(--code-preview-foreground);font-style:italic;">unit</span> </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-punctuation-mark)"> "</span><span style="color:var(--code-preview-token-string-expression)">s</span><span style="color:var(--code-preview-token-punctuation-mark)">"</span></span><span style="color:var(--code-preview-token-punctuation-mark)">, <span style="color:var(--code-preview-foreground);font-style:italic;">utc</span> </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-constant)"> True</span><span style="color:var(--code-preview-token-bracket)">),</span></span>
...
${p ? '\t' : ''}<span class="line"></span>`;
			if (daily.constructor === Array) {
				for (const d of daily) {
					c += `
${p ? '\t' : ''}<span class="line"><span style="color:var(--code-preview-foreground)">daily_data</span><span style="color:var(--code-preview-token-punctuation-mark)">[</span><span style="color:var(--code-preview-token-punctuation-mark)">"</span><span style="color:var(--code-preview-token-string-expression)">${d}"</span><span style="color:var(--code-preview-token-punctuation-mark)">]</span><span style="color:var(--code-preview-token-keyword)"> =</span><span style="color:var(--code-preview-foreground)"> daily_${d}</span></span>`;
				}
			} else {
				c += `
${p ? '\t' : ''}<span class="line"><span style="color:var(--code-preview-foreground)">daily_data</span><span style="color:var(--code-preview-token-punctuation-mark)">[</span><span style="color:var(--code-preview-token-punctuation-mark)">"</span><span style="color:var(--code-preview-token-string-expression)">${daily}"</span><span style="color:var(--code-preview-token-punctuation-mark)">]</span><span style="color:var(--code-preview-token-keyword)"> =</span><span style="color:var(--code-preview-foreground)"> daily_${daily}</span></span>`;
			}
			c += `
${p ? '\t' : ''}<span class="line"></span>
${p ? '\t' : ''}<span class="line"><span style="color:var(--code-preview-foreground)">daily_dataframe </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-foreground)"> pd</span><span style="color:var(--code-preview-token-punctuation-mark)">.</span><span style="color:var(--code-preview-token-function)">DataFrame</span><span style="color:var(--code-preview-token-bracket)">(<span style="color:var(--code-preview-foreground);font-style:italic;">data</span> </span><span style="color:var(--code-preview-token-keyword)">=</span><span style="color:var(--code-preview-token-punctuation)"> daily_data<span style="color:var(--code-preview-token-bracket)">)</span></span></span>
${p ? '\t' : ''}<span class="line"><span style="color:var(--code-preview-token-function)">print</span><span style="color:var(--code-preview-token-bracket)">("<span style="color:var(--code-preview-token-string-expression)">\\nDaily data\\n</span>", <span style="color:var(--code-preview-token-function)">daily_dataframe</span>)</span></span>
${p ? '\t' : ''}<span class="line"></span>`;
		}
		c += `</pre>`;
		return c;
