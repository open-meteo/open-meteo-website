...
{#if updated.current && !updateNotificationClicked}
	<div
		...
		role="status"
		aria-live="polite"
		class="fixed top-0 z-100 flex max-h-screen w-full flex-col-reverse p-4 pr-8 sm:top-auto sm:right-0 sm:bottom-0 sm:flex-col md:max-w-118.75"
	>
		<div
		...
		>
			...
			<Button
				variant="outline"
				class="hover:bg-secondary focus:ring-ring group-[.destructive]:border-muted/40 group-[.destructive]:hover:border-destructive/30 group-[.destructive]:hover:bg-destructive group-[.destructive]:hover:text-destructive-foreground group-[.destructive]:focus:ring-destructive mr-2 inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-transparent px-3 text-sm font-medium transition-colors focus:ring-1 focus:outline-none disabled:pointer-events-none disabled:opacity-50"
