...
${p ? '\t' : ''}<span class="line"><span style="color:var(--code-preview-token-comment);font-style:italic"># Process ${titleCase(section)} data. The order of variables needs to be the same as requested.</span></span>
