...
${indent ? '\t' : ''}<span class="line"><span style="color:var(--code-preview-token-keyword)">let</span><span style="color:var(--code-preview-foreground)"> elevation </span><span style="color:var(--code-preview-token-punctuation-mark)">=</span><span style="color:var(--code-preview-foreground)"> response<span style="color:var(--code-preview-token-punctuation-mark)">.</span>elevation</span></span>`;
	if (params.timezone) {
		c += `
...
${indent ? '\t' : ''}<span class="line"><span style="color:var(--code-preview-token-keyword)">let</span><span style="color:var(--code-preview-foreground)"> ${camelCase(section)} </span><span style="color:var(--code-preview-token-punctuation-mark)">=</span><span style="color:var(--code-preview-foreground)"> response<span style="color:var(--code-preview-token-punctuation-mark)">.</span>${camelCase(section)}</span><span style="color:var(--code-preview-token-punctuation-mark)">!</span></span>`;
	...
	c += `
${indent ? '\t' : ''}<span class="line"></span>
${indent ? '\t' : ''}<span class="line"><span style="color:var(--code-preview-token-comment);font-style:italic;">/// Note: The order of weather variables in the URL query and the 'at' indices below need to match!</span></span>
...
${indent ? '\t' : ''}<span class="line"><span style="color:var(--code-preview-token-function)">		${sect}</span><span style="color:var(--code-preview-token-punctuation-mark)">:</span><span style="color:var(--code-preview-token-function)"> current.variables</span><span style="color:var(--code-preview-token-punctuation)">(</span><span style="color:var(--code-preview-token-function)">at</span><span style="color:var(--code-preview-token-punctuation-mark)">:</span><span style="color:var(--code-preview-token-constant)"> 0</span><span style="color:var(--code-preview-token-punctuation)">)</span><span style="color:var(--code-preview-token-punctuation-mark)">!</span><span style="color:var(--code-preview-token-function)">.</span><span style="color:var(--code-preview-token-constant)">value</span></span>`;
			...
			c += `
${indent ? '\t' : ''}<span class="line"><span style="color:var(--code-preview-token-punctuation-mark)">	)</span><span style="color:var(--code-preview-token-variable)">,</span></span>`;
		}
	}
...
${indent ? '\t' : ''}<span class="line"></span>
${indent ? '\t' : ''}<span class="line"><span style="color:var(--code-preview-token-comment);font-style:italic;">/// Timezone '.gmt' is deliberately used.</span></span>
${indent ? '\t' : ''}<span class="line"><span style="color:var(--code-preview-token-comment);font-style:italic;">/// By adding 'utcOffsetSeconds' before, local-time is inferred</span></span>
...
${indent ? '\t' : ''}<span class="line"><span style="color:var(--code-preview-foreground)">dateFormatter<span style="color:var(--code-preview-token-punctuation-mark)">.</span>timeZone </span><span style="color:var(--code-preview-token-punctuation-mark)">=</span><span style="color:var(--code-preview-foreground)"> .gmt</span></span>
${indent ? '\t' : ''}<span class="line"><span style="color:var(--code-preview-foreground)">dateFormatter<span style="color:var(--code-preview-token-punctuation-mark)">.</span>dateFormat </span><span style="color:var(--code-preview-token-punctuation-mark)">=</span><span style="color:var(--code-preview-token-string-expression)"> <span style="color:var(--code-preview-token-punctuation-mark)">"</span>yyyy-MM-dd HH:mm<span style="color:var(--code-preview-token-punctuation-mark)">"</span></span></span>
${indent ? '\t' : ''}<span class="line"></span>`;
...
${indent ? '\t' : ''}<span class="line"><span style="color:var(--code-preview-token-punctuation-mark)">}</span></span>`;
	...
	c += `
${indent ? '<span class="line"><span style="color:var(--code-preview-token-punctuation-mark)">}</span></span>' : ''}</code></pre></div>`;
	return c;
};
