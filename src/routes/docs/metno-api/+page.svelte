...
<div class="alert alert-primary" role="alert">
	...
	forecasts of up to 16 days, the <a href={i18n.route('/docs')}>generic Weather Forecast API</a> transparently
...
<div class="col-12 py-5">
	...
	<p>
		Unfortunately, only 2.5 days of forecast are available. The Open-Meteo <a
