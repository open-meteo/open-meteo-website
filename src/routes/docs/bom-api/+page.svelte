<script lang="ts">
	...
	import StartEndDate from '$lib/components/StartEndDate.svelte';
	...
	import { daily, hourly, solarVariables, defaultParameters, additionalVariables } from './options';
...
<div class="alert alert-primary" role="alert">
	This API provides weather forecasts based on the global ACCESS-G model from the Australian Bureau
	of Meteorology (BOM). For more comprehensive applications, we recommend the <a
		href={i18n.route('/docs')}>Weather Forecast API</a
	...
	<div class="table-responsive">
		<table class="table">
			...
			<tbody>
				...
				<tr>
					<th scope="row">
						soil_moisture_0_to_10cm<br />soil_moisture_10_to_35cm<br />soil_moisture_35_to_100cm<br
