...
<svelte:head>
	...
	/>
	<link rel="preload" fetchpriority="high" as="image" href="/images/snowy.webp" type="image/webp" />
</svelte:head>
	...
	<div class="row g-4 py-md-5 row-cols-1 row-cols-lg-3">
		<div class="feature col">
			<div class="feature-title">
				...
				<h2 class="ps-3">Free for non-commercial</h2>
			</div>
			<p>
		...
		<div class="feature col">
			<div class="feature-title">
				...
				<h2 class="ps-3">Commercial Use License</h2>
			</div>
			<p>
		...
		<div class="feature col">
			<div class="feature-title">
				...
				<h2 class="ps-3">Large API Call Volume</h2>
			</div>
			<p>
		...
		<div class="feature col">
			<div class="feature-title">
				...
				<h2 class="ps-3">Excellent Uptime, Low Latency</h2>
			</div>
			<p>
		...
		<div class="feature col">
			<div class="feature-title">
				...
				<h2 class="ps-3">Flexible Payment Options</h2>
			</div>
			<p>
		...
		<div class="feature col">
			<div class="feature-title">
				...
				<h2 class="ps-3">Transparent Pricing, Flexible Cancellation</h2>
			</div>
			<p>
...
<div class="container px-4 py-md-5 mt-5" id="faq">
	<h2 id="faq" class="text-center pb-2 display-5">Frequently Asked Questions</h2>
