...
let params = {latitude: 54.3213, longitude: 10.1348}
...
<svelte:head>
    ...
    <meta name="description" content="Marine Weather API with ocean wave forecasts. Free access for non-commercial use. Access detailed ocean wave forecasts generated by local and global models. Stay informed about wave conditions and make well-informed decisions for your marine activities. Enhance safety and optimize your maritime operations with accurate and reliable marine weather data.">
</svelte:head>
