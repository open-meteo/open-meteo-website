...
<div class="alert alert-primary" role="alert">
  This API offers access to the renowned ICON weather models from the German Weather service DWD, delivering 15-minutely data for short-term forecasts in central Europe and 11 km resolution global forecasts. The ICON model is a preferred choice in <a
  href="/en/docs">generic weather forecast API</a> if no other high resolution weather models are available.
</div>
  ...
  <form id="api_form" method="get" action="https://api.open-meteo.com/v1/dwd-icon">
    ...
    <div class="row py-3 px-0">
      ...
      <div class="col-md-3">
        ...
        <!---<div class="form-check">
          ...
          <div class="form-check">
            <input class="form-check-input" type="checkbox" value="sensible_heatflux" id="sensible_heatflux" name="hourly">
            <label class="form-check-label" for="sensible_heatflux">
              Sensible heat flux
            </label>
          </div>-->
    ...
    <div class="row py-3 px-0">
      ...
      <div class="col-md-6">
        <div class="form-check">
          <input class="form-check-input" type="checkbox" value="precipitation" id="precipitation_15min" name="minutely_15">
          <label class="form-check-label" for="precipitation_15min">
            Precipitation (rain + showers + snow)
          </label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="checkbox" value="rain" id="rain_15min" name="minutely_15">
          <label class="form-check-label" for="rain_15min">
            Rain
          </label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="checkbox" value="snowfall" id="snowfall_15min" name="minutely_15">
          <label class="form-check-label" for="snowfall_15min">
            Snowfall
          </label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="checkbox" value="snowfall_height" id="snowfall_height_15min" name="minutely_15">
          <label class="form-check-label" for="snowfall_height_15min">
            Snowfall Height
          </label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="checkbox" value="freezinglevel_height" id="freezinglevel_height_15min"
            name="minutely_15">
          <label class="form-check-label" for="freezinglevel_height_15min">
            Freezinglevel Height
          </label>
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-check">
          <input class="form-check-input" type="checkbox" value="cape" id="cape_15min"
            name="minutely_15">
          <label class="form-check-label" for="cape_15min">
            CAPE
          </label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="checkbox" value="lightning_potential" id="lightning_potential_15min"
            name="minutely_15">
          <label class="form-check-label" for="lightning_potential_15min">
    ...
    <div class="row py-3 px-0">
      <div class="accordion" id="accordionVariables_15min">
        <div class="accordion-item">
          <h2 class="accordion-header" id="heading-solar-variables_15min">
            <button class="accordion-button collapsed py-2" type="button" data-bs-toggle="collapse"
              data-bs-target="#collapse-solar-variables_15min" aria-expanded="false" aria-controls="collapse-solar-variables_15min">
              Solar Radiation Variables&nbsp;<span class="badge rounded-pill bg-secondary checkboxcounter"
                data-count-checkboxes-of="#collapse-solar-variables_15min">0/x</span>
            </button>
          </h2>
          <div id="collapse-solar-variables_15min" class="accordion-collapse collapse"
            aria-labelledby="heading-solar-variables_15min" data-bs-parent="#accordionVariables_15min">
            <div class="accordion-body row">
              <div class="col-md-6">
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" value="shortwave_radiation" id="shortwave_radiation_minutely_15"
                    name="minutely_15">
                  <label class="form-check-label" for="shortwave_radiation_minutely_15">
                    Shortwave Solar Radiation
                  </label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" value="direct_radiation" id="direct_radiation_minutely_15"
                    name="minutely_15">
                  <label class="form-check-label" for="direct_radiation_minutely_15">
                    Direct Solar Radiation
                  </label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" value="diffuse_radiation" id="diffuse_radiation_minutely_15"
                    name="minutely_15">
                  <label class="form-check-label" for="diffuse_radiation_minutely_15">
                    Diffuse Solar Radiation
                  </label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" value="direct_normal_irradiance"
                    id="direct_normal_irradiance_minutely_15" name="minutely_15">
                  <label class="form-check-label" for="direct_normal_irradiance_minutely_15">
                    Direct Normal Irradiance DNI
                  </label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" value="terrestrial_radiation"
                    id="terrestrial_radiation_minutely_15" name="minutely_15">
                  <label class="form-check-label" for="terrestrial_radiation_minutely_15">
                    Terrestrial Solar Radiation
                  </label>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" value="shortwave_radiation_instant"
                    id="shortwave_radiation_instant_minutely_15" name="minutely_15">
                  <label class="form-check-label" for="shortwave_radiation_instant_minutely_15">
                    Shortwave Solar Radiation (Instant)
                  </label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" value="direct_radiation_instant"
                    id="direct_radiation_instant_minutely_15" name="minutely_15">
                  <label class="form-check-label" for="direct_radiation_instant_minutely_15">
                    Direct Solar Radiation (Instant)
                  </label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" value="diffuse_radiation_instant"
                    id="diffuse_radiation_instant_minutely_15" name="minutely_15">
                  <label class="form-check-label" for="diffuse_radiation_instant_minutely_15">
                    Diffuse Solar Radiation (Instant)
                  </label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" value="direct_normal_irradiance_instant"
                    id="direct_normal_irradiance_instant_minutely_15" name="minutely_15">
                  <label class="form-check-label" for="direct_normal_irradiance_instant_minutely_15">
                    Direct Normal Irradiance DNI (Instant)
                  </label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" value="terrestrial_radiation_instant"
                    id="terrestrial_radiation_instant_minutely_15" name="minutely_15">
                  <label class="form-check-label" for="terrestrial_radiation_instant_minutely_15">
                    Terrestrial Solar Radiation (Instant)
                  </label>
                </div>
              </div>
              <div class="col-md-12">
                <small class="text-muted">Note: Solar radiation is averaged over the past 15 minutes. Use
                  <mark>instant</mark> for radiation at the indicated time.</small>
              </div>
            </div>
          </div>
    ...
    <small class="text-muted">* Only available in Central Europe (otherwise just interpolated data) and limited to 3 days of forecast</small>
  ...
  <div class="col-12 py-5">
    ...
    <p>This API uses global DWD ICON weather forecast and combines them with high-resolution ICON Europe and Central Europe forecasts. Information about DWD wearther models is available <a href="https://www.dwd.de/EN/ourservices/nwp_forecast_data/nwp_forecast_data.html" target="_blank">here</a>. For ICON Global and Europe, values are interpolated from 3-hourly to 1-hourly after 78 hours. 15-minutely data is only available for a small number of weather variables and only in Central Europe.</p>
    ...
    <p>The API endpoint <mark>/v1/dwd-icon</mark> accepts a geographical coordinate, a list of weather variables and
    ...
    <div class="table-responsive">
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            <th scope="row">windspeed_10m<br />windspeed_80m<br>windspeed_120m<br>windspeed_180m</th>
            <td>Instant</td>
            <td>km/h (mph, m/s, knots)</td>
            <td>Wind speed at 10, 80, 120 or 180 meters above ground. Wind speed on 10 meters is the standard level.
            </td>
          </tr>
          <tr>
            <th scope="row">winddirection_10m<br>winddirection_80m<br />winddirection_120m<br />winddirection_180m</th>
            <td>Instant</td>
            <td>°</td>
          ...
          <tr>
            ...
            <td>Instant</td>
            <td>meters</td>
            <td>Height of snowfall limit above mean sea level. It is defined as the height where the wet bulb temperature first exceeds 1.3◦C.</td>
          </tr>
          <tr>
          ...
          <tr>
            <th scope="row">
              soil_temperature_0cm<br />soil_temperature_6cm<br />soil_temperature_18cm<br />soil_temperature_54cm</th>
            <td>Instant</td>
            <td>°C (°F)</td>
            <td>Temperature in the soil at 0, 6, 18 and 54 cm depths. 0 cm is the surface temperature on land or water
              surface temperature on water.</td>
          </tr>
          <tr>
            <th scope="row">
              soil_moisture_0_1cm<br />soil_moisture_1_3cm<br />soil_moisture_3_9cm<br />soil_moisture_9_27cm<br />soil_moisture_27_81cm
            </th>
            <td>Instant</td>
            <td>m³/m³</td>
    ...
    <p>The parameter <mark>&minutely_15=</mark> can be used to get 15-minutely data. This data is based on the ICON-D2 model which is only available in Central Europe.
    If 15-minutely data is requested for locations outside Central Europe, data is interpolated from 1-hourly to 15-minutely.</p>
    <div class="table-responsive">
      <table class="table">
        <thead>
          <tr>
        ...
        <tbody>
          <tr>
            ...
            <td>Preceding hour mean</td>
            <td>W/m²</td>
            <td>Shortwave solar radiation as average of the preceding 15 minutes. This is equal to the total global horizontal
              irradiation </td>
          </tr>
          <tr>
            <th scope="row">direct_radiation<br />direct_normal_irradiance</th>
            <td>Preceding hour mean</td>
            <td>W/m²</td>
            <td>Direct solar radiation as average of the preceding 15 minutes on the horizontal plane and the normal plane
              (perpendicular to the sun)</td>
          </tr>
          <tr>
            <th scope="row">diffuse_radiation</th>
      ...
      <table class="table">
        ...
        <tbody>
          <tr>
            ...
            <td>°C (°F)</td>
            <td>Air temperature at the specified pressure level. Air temperatures decrease linearly with pressure.</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>Cloud cover at the specified pressure level. Cloud cover is approximated based on relative humidity
              using <a
                ...
                target="_blank">Sundqvist et al. (1989)</a>. It may not match perfectly with low, mid and high cloud
              cover variables.</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>meter</td>
            <td>Geopotential height at the specified pressure level. This can be used to get the correct altitude in
              meter above sea level of each pressure level. Be carefull not to mistake it with altitude above ground.
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            <th scope="row">elevation</th>
            <td>Floating point</td>
            <td>The elevation from a 90 meter digital elevation model. This effects which grid-cell is selected (see parameter <mark>cell_selection</mark>). 
              Statistical downscaling is used to adapt weather conditions for this elevation. This elevation can also be controlled with the query parameter <mark>elevation</mark>. If <mark>&elevation=nan</mark> is specified, all downscaling is disabled and the averge grid-cell elevation is used.</td>
          </tr>
          <tr>
