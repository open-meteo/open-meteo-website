...
<!--<div class="mb-5" style="border-bottom: 1px solid #ddd">
  ...
  <div class="col-12 py-5">
    ...
    <p>The API endpoint <mark>/v1/forecast</mark> accepts a geographical coordinate, a list of weather variables and
      responds with a JSON hourly weather forecast for 7 days. Time always starts at 0:00 today and contains 168 hours. If
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>Instant</td>
            <td>kPa</td>
            <td>Vapor Pressure Deficit (VPD) in kilopascal (kPa). For high VPD (&gt;1.6), water transpiration of plants
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>Index</td>
            <td>Daily maximum in UV Index starting from 0. <mark>uv_index_clear_sky_max</mark> assumes cloud free conditions. Please follow the <a href="https://www.who.int/news-room/questions-and-answers/item/radiation-the-ultraviolet-(uv)-index">official WMO guidelines</a> for ultraviolet index.</td>
          </tr>
        </tbody>
      </table>
    </div>
