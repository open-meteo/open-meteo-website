	...
	<div class="mt-2 md:mt-4">
		<div class="grid gap-4 md:gap-6 lg:grid-cols-2">
			...
			<p>
				...
				dropdown (just below the hourly variables) to select and compare individual models. To
				access the full archive of past forecast runs as issued — useful for forecast verification
				or training ML models — see the
