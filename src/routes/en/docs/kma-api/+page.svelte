...
<div class="mt-6 md:mt-12">
	...
	<div class="mt-2 md:mt-4">
		<p>
			KMA directly predicts the fields listed below. Open-Meteo retains these fields or uses them to
			calculate more convenient API variables. KMA provides both global and direct solar radiation
			and a native 2 m cloud cover (fog) field.
		</p>
		<div class="-mx-6 overflow-auto md:ml-0 lg:mx-0">
			<table class="docs-table w-full min-w-300">
				<thead>
					<tr>
						<th scope="col">Native KMA field</th>
				...
				<tbody>
					...
					<tr>
						<th scope="row">Precipitation, convective precipitation (GDPS) and snowfall</th>
						<td>Surface</td>
						<td><mark>precipitation</mark>, <mark>rain</mark>, showers, snowfall</td>
					</tr>
					<tr>
					...
					<tr>
						<th scope="row">Cloud cover low, mid, high and fog fraction</th>
						<td>Surface</td>
						<td>Cloud cover layers and <mark>cloud_cover_2m</mark></td>
					</tr>
					<tr>
						<th scope="row">Visibility and CAPE (GDPS)</th>
						<td>Surface</td>
						<td><mark>visibility</mark>, <mark>cape</mark> and weather-code inputs</td>
					</tr>
				</tbody>
			</table>
		</div>
		<p class="mt-2">
			CAPE, 50 m wind and convective precipitation are only available in the global GDPS model. The
			total cloud cover is combined from the layers because the native total reads too high.
		</p>
	</div>
</div>
...
<div class="mt-6 md:mt-12">
	...
	<div class="mt-2 md:mt-4">
		<p>
			KMA publishes relative humidity, cloud cover layers, a 2 m cloud cover (fog) field and both
			global and direct solar radiation natively. Open-Meteo derives the remaining API variables
			from these native fields.
		</p>
		<div class="-mx-6 overflow-auto md:ml-0 lg:mx-0">
			<table class="docs-table w-full min-w-300">
				<thead>
				...
				<tbody>
					<tr>
						...
						<td>
							Combined from the native low, mid and high cloud layers. KMA's own total cloud field
							is not used because it reads too high.
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td> Calculated from the native U and V wind components at 10 m and 50 m. </td>
					</tr>
					<tr>
						<th scope="row">Snowfall and rain</th>
						<td>
							Snowfall converts the native snowfall water equivalent with 0.7 cm per mm. Rain is
							total precipitation minus snowfall water equivalent (and showers for GDPS).
						</td>
					</tr>
					<tr>
						<th scope="row">Diffuse radiation and DNI</th>
						<td>
							Diffuse radiation is separated from global radiation with the Razo, Müller Witwer
							model. DNI follows from native direct radiation, together with GTI and instant values.
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							...
							Penman-Monteith equation; sunshine duration counts time with native DNI above 120
							W/m².
						</td>
					</tr>
				</tbody>
