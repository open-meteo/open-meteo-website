...
<svelte:head>
	...
	<meta
		name="description"
		content="Météo-France AROME and ARPEGE weather forecasts with up to 1.5 km resolution for France and Europe. Free weather API, 15-minutely data, no key required."
	/>
</svelte:head>
...
<form
	method="get"
	action={apiModeFormAction($params.api_mode, 'https://api.open-meteo.com/v1/meteofrance')}
>
	<!-- LOCATION -->
