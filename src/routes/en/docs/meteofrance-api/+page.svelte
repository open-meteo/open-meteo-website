...
const levels = [10, 20, 30, 50, 70, 100, 125, 150, 175, 200, 225, 250, 275, 300, 350, 400, 450, 500, 550, 600, 650, 700, 750, 800, 850, 900, 925, 950, 1000].reverse()
</script>
...
<div class="px-4 py-5 text-center text-white" style="
            background-image: url('/images/overcast_sunset.webp');
  ...
  <h1 class="display-5" style="text-shadow: 3px 3px 2px rgba(0, 0, 0, .7);">MeteoFrance API</h1>
  <div class="col-lg-6 mx-auto">
    <p class="lead mb-4" style="text-shadow: 3px 3px 2px rgba(0, 0, 0, .7);">Global ARPEGE model combined with high resolution AROME model</p>
  ...
  <div class="container px-4 py-1">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ol class="breadcrumb mb-0">
        ...
        <li class="breadcrumb-item active" aria-current="page">MeteoFrance API</li>
      </ol>
    </nav>
  </div>
</div>
...
<div class="container px-4 py-0" id="featured-3">
  ...
  <div class="col-12 py-5">
    ...
    <p>This API uses global MeteoFrance ARPEGE weather forecast and combines them with high-resolution AROME forecasts. AROME is a 1.5 km high resolution model covering France and neighboring areas. For
      other locations, only ARPEGE is used. For ARPEGE, values are interpolated from 3 or 6-hourly to 1-hourly values after 72 or 96 hours respectively.</p>
    <div class="table-responsive">
      <table class="table">
        ...
        <tbody>
          <tr>
            <th scope="row"><a href="https://mf-models-on-aws.org/en/doc/models/arpege-world/" target="_blank">Arpege World</a></th>
            <td>Global</td>
            <td>0.5° (~55 km)</td>
          ...
          <tr>
            <th scope="row"><a href="https://mf-models-on-aws.org/en/doc/models/arpege-europe/" target="_blank">Arpege Europe</a></th>
            <td>Europe</td>
            <td>0.1° (~11 km)</td>
      ...
      <small class="text-muted">* Arome France HD only contains a small selection of weather variables.</small>
    </div>

    <h2 id="api-documentation" class="mt-5">API Documentation</h2>
    <p>The API endpoint <mark>/v1/meteofrance</mark> accepts a geographical coordinate, a list of weather variables and responds
      with a JSON hourly weather forecast for 4 days. Time always starts at 0:00 today and contains 168 hours. All URL parameters are listed
      below:
    </p>
    <div class="table-responsive">
      <table class="table">
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>Preceding hour mean</td>
            <td>W/m²</td>
            <td>Direct solar radiation as average of the preceding hour on the horizontal plane and the normal plane (perpendicular to the sun). MeteoFrance does not offers diffuse and direct radiation directly. It is approximated based on <a href="https://www.ise.fraunhofer.de/content/dam/ise/de/documents/publications/conference-paper/36-eupvsec-2019/Guzman_5CV31.pdf" target="_blank">Razo, Müller Witwer</a></td>
          </tr>
          <tr>
            <th scope="row">diffuse_radiation</th>
            <td>Preceding hour mean</td>
            <td>W/m²</td>
            <td>Diffuse solar radiation as average of the preceding hour. HRRR offers diffuse radiation directly. MeteoFrance does not offers diffuse and direct radiation directly. It is approximated based on <a href="https://www.ise.fraunhofer.de/content/dam/ise/de/documents/publications/conference-paper/36-eupvsec-2019/Guzman_5CV31.pdf" target="_blank">Razo, Müller Witwer</a></td>
          </tr>
          <tr>
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>%</td>
            <td>Cloud cover at the specified pressure level. ARPEGE Wold and Europe includes parameterised cloud cover directly. AROME cloud cover is approximated based on relative humidity
              using <a
