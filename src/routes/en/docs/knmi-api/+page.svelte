...
<div class="mt-6 md:mt-12">
	...
	<div class="mt-2 md:mt-4">
		<p>
			HARMONIE AROME directly predicts the fields listed below. Open-Meteo retains these fields or
			uses them to calculate more convenient API variables. The model provides wind as U and V
		...
		<div class="-mx-6 overflow-auto md:ml-0 lg:mx-0">
			<table class="docs-table w-full min-w-300">
				<thead>
					<tr>
						<th scope="col">Native KNMI field</th>
				...
				<tbody>
					<tr>
						...
						<td>2 m, 50/100/200/300 m, surface, pressure levels</td>
					...
					<tr>
						...
						<td>10 m to 300 m, pressure levels</td>
						<td>Wind speed and direction</td>
					</tr>
					<tr>
						<th scope="row">Wind gust components</th>
						<td>10 m</td>
					...
					<tr>
						<th scope="row">Precipitation, rain and snowfall water equivalent</th>
						<td>Surface</td>
						<td><mark>precipitation</mark>, <mark>rain</mark>, snowfall, showers</td>
					</tr>
					<tr>
					...
					<tr>
						<th scope="row">Visibility and snow depth</th>
						<td>Surface</td>
						<td><mark>visibility</mark>, <mark>snow_depth_water_equivalent</mark></td>
					</tr>
					<tr>
						<th scope="row">Geopotential</th>
						<td>Pressure levels (Europe)</td>
						<td><mark>geopotential_height</mark></td>
					</tr>
				</tbody>
			</table>
		</div>
...
<div class="mt-6 md:mt-12">
	...
	<div class="mt-2 md:mt-4">
		<p>
			HARMONIE AROME natively provides temperature, relative humidity, cloud cover, precipitation,
			visibility and global solar radiation. Several convenient API variables are not direct model
			output — Open-Meteo derives them from the native fields for every forecast step.
		</p>
		<div class="-mx-6 overflow-auto md:ml-0 lg:mx-0">
			<table class="docs-table w-full min-w-300">
				<thead>
				...
				<tbody>
					<tr>
						...
						<td>
							Calculated from the native U and V wind components. On the rotated Europe grid the
							direction is corrected for the projection; without this correction it would be off by
							up to 15°.
						</td>
					</tr>
					<tr>
					...
					<tr>
						<th scope="row">Snowfall and showers</th>
						<td>
							Snowfall converts the native snowfall water equivalent with 0.7 cm per mm. Showers are
							precipitation minus the native rain and snowfall water equivalent.
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							Estimated from pressure-level relative humidity and temperature (Europe model only).
						</td>
					</tr>
				</tbody>
			</table>
