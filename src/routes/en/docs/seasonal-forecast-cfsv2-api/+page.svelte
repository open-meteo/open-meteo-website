...
<svelte:head>
	<title>Seasonal Weather Forecast CFSv2 API | Open-Meteo.com</title>
	<link rel="canonical" href="https://open-meteo.com/en/docs/seasonal-forecast-cfsv2-api" />
</svelte:head>
...
<Alert.Root variant="info" class="mb-4"
	...
	>
	<Alert.Description>This seasonal forecast uses NCEP CFSv2. This API is work in progress and my break at any time!</Alert.Description>
</Alert.Root>
