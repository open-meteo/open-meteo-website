...
<div class="px-4 py-5 text-center text-white" style="
            background-image: url('/images/cloudy_cirrus.webp');
  ...
  <h1 class="display-5" style="text-shadow: 3px 3px 2px rgba(0, 0, 0, .7);">JMA API</h1>
  <div class="col-lg-6 mx-auto">
    <p class="lead mb-4" style="text-shadow: 3px 3px 2px rgba(0, 0, 0, .7);">5-km high resolution forecasts for Japan, Korea, parts of China and Russia</p>
  ...
  <div class="container px-4 py-1">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ol class="breadcrumb mb-0">
        ...
        <li class="breadcrumb-item active" aria-current="page">JMA API</li>
      </ol>
    </nav>
  </div>
</div>
...
<div class="container px-4 py-0" id="featured-3">
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="heading-solar-variables">
            <button class="accordion-button collapsed py-2" type="button" data-bs-toggle="collapse"
              ...
              Solar Radiation Variables (Only available for Japan) &nbsp;<span class="badge rounded-pill bg-secondary checkboxcounter"
  ...
  <div class="col-12 py-5">
    ...
    <p>This API uses global and local weather models from the Japan Meteorological Agency JMA. Due to data license restrictions only a limited version of data is available. A list of official JMA data is available on the <a target="_blank" href="https://www.jma.go.jp/jma/en/Activities/nwp.html">JMA website</a>. For GSM, values are interpolated from 6-hourly to 1-hourly values.</p>
    ...
    <p>The API endpoint <mark>/v1/jma</mark> accepts a geographical coordinate, a list of weather variables and responds
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>Preceding hour mean</td>
            <td>W/m²</td>
            <td>Direct solar radiation as average of the preceding hour on the horizontal plane and the normal plane (perpendicular to the sun). JMA does not offers diffuse and direct radiation directly. It is approximated based on <a href="https://www.ise.fraunhofer.de/content/dam/ise/de/documents/publications/conference-paper/36-eupvsec-2019/Guzman_5CV31.pdf" target="_blank">Razo, Müller Witwer</a></td>
          </tr>
          <tr>
            <th scope="row">diffuse_radiation</th>
            <td>Preceding hour mean</td>
            <td>W/m²</td>
            <td>Diffuse solar radiation as average of the preceding hour.  MA does not offers diffuse and direct radiation directly. It is approximated based on <a href="https://www.ise.fraunhofer.de/content/dam/ise/de/documents/publications/conference-paper/36-eupvsec-2019/Guzman_5CV31.pdf" target="_blank">Razo, Müller Witwer</a></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>Weather condition as a numeric code. Follow WMO weather interpretation codes. See table below for
              details. Weather code is calculated from cloud cover analysis, precipitation and snowfall. As JMA has barely no information about atmospheric stability, estimation about thunderstorms is not possible.</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>Snowfall amount of the preceding hour in centimeters. For the water equivalent in millimeter, divide by
              7. E.g. 7 cm snow = 10 mm precipitation water equivalent. Snowfall amount is not provided by JMA directly, instead it is approximated based on total precipitation and temperature</td>
          </tr>
        </tbody>
      </table>
    </div>
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>%</td>
            <td>Cloud cover at the specified pressure level. JMA models do not inlude parameterised cloud cover directly. It is approximated based on relative humidity
              using <a
