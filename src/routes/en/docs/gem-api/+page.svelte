...
<div class="px-4 py-5 text-center text-white" style="
            background-image: url('/images/coastal.webp');
  ...
  <h1 class="display-5" style="text-shadow: 3px 3px 2px rgba(0, 0, 0, .7);">GEM API</h1>
  <div class="col-lg-6 mx-auto">
    <p class="lead mb-4" style="text-shadow: 3px 3px 2px rgba(0, 0, 0, .7);">2.5 km high resolution forecasts for North America</p>
  ...
  <div class="container px-4 py-1">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ol class="breadcrumb mb-0">
        ...
        <li class="breadcrumb-item active" aria-current="page">CMC GEM API</li>
      </ol>
    </nav>
  </div>
</div>
...
<div class="container px-4 py-0" id="featured-3">
  ...
  <form id="api_form" method="get" action="https://api.open-meteo.com/v1/gem">
    <div class="row py-3 px-0">
      ...
      <div class="col-md-3">
        <div class="form-floating">
          <input type="number" step="0.0001" class="form-control" name="latitude" id="latitude" value="35.678">
          <label for="latitude">Latitude</label>
        </div>
      </div>
      <div class="col-md-3">
        <div class="form-floating">
          <input type="number" step="0.0001" class="form-control" name="longitude" id="longitude" value="139.682">
    ...
    <div class="row py-3 px-0">
      ...
      <div class="col-md-3">
        ...
        <div class="form-check">
          <input class="form-check-input" type="checkbox" value="cape" id="cape" name="hourly">
      ...
      <div class="col-md-3">
        ...
        <div class="form-check">
          <input class="form-check-input" type="checkbox" value="windspeed_40m" id="windspeed_40m" name="hourly">
          <label class="form-check-label" for="windspeed_40m">
            Wind Speed (40 m)
          </label>
        </div>
        <div class="form-check">
        ...
        <div class="form-check">
          <input class="form-check-input" type="checkbox" value="winddirection_40m" id="winddirection_40m"
            name="hourly">
          <label class="form-check-label" for="winddirection_40m">
            Wind Direction (40 m)
          </label>
        </div>
        <div class="form-check">
      ...
      <div class="col-md-3">
        <div class="form-check">
          <input class="form-check-input" type="checkbox" value="temperature_40m" id="temperature_40m" name="hourly">
          <label class="form-check-label" for="temperature_40m">
            Temperature (40 m)
          </label>
        </div>
        <div class="form-check">
                ...
                <div class="tab-content" id="v-pills-tabContent">
                  ...
                  <div class="mt-3">
                    <small class="text-muted">Note: Altitudes are approximate and in meters <strong> above sea
                        level</strong> (not above ground). Use <mark>geopotential_height</mark> to get precise altitudes
                      above sea level.</small>
                  </div>
                </div>
              </div>
            </div>
  ...
  <div class="col-12 py-5">
    ...
    <p>This API uses <a href="https://en.wikipedia.org/wiki/Global_Environmental_Multiscale_Model" target="_new">Global Environmental Multiscale Model (GEM)</a> from the Canadian weather service. Global and regional weather models are combined into a seamless prediction. For GEM Global, values are interpolated from 3-hourly to 1-hourly values.</p>
    <div class="table-responsive">
      <table class="table">
        ...
        <tbody>
          <tr>
            <th scope="row"><a href="https://weather.gc.ca/grib/grib2_glb_25km_e.html" target="_blank">GEM Global</a></th>
            <td>Global</td>
            <td>0.15° (~15 km)</td>
            <td>3-Hourly</td>
            <td>10 days</td>
          ...
          <tr>
            <th scope="row"><a href="https://weather.gc.ca/grib/grib2_reg_10km_e.html" target="_blank">GEM Regional</a></th>
          ...
          <tr>
            <th scope="row"><a href="https://weather.gc.ca/grib/grib2_HRDPS_HR_e.html" target="_blank">HRDPS Continental</a></th>
    ...
    <p>The API endpoint <mark>/v1/gem</mark> accepts a geographical coordinate, a list of weather variables and responds
      with a JSON hourly weather forecast for 7 days. Time always starts at 0:00 today and contains 168 hours. All URL parameters are listed
      below:
    </p>
    <div class="table-responsive">
      <table class="table">
    ...
    <div class="table-responsive">
      <table class="table">
        ...
        <tbody>
          <tr>
            <th scope="row">temperature_2m<br/>temperature_40m<br/>temperature_80m<br/>temperature_120m</th>
            <td>Instant</td>
            <td>°C (°F)</td>
            <td>Air temperature at 2, 40, 80 or 120 meters above ground. 2 m is the standard level.</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>Instant</td>
            <td>%</td>
            <td>Low level clouds and fog up to 3 km altitude. Note: Low, medium and high clouds are calculated from pressure level data. Totcal cloud cover might differ.</td>
          </tr>
          <tr>
          ...
          <tr>
            <th scope="row">windspeed_10m<br />windspeed_40m<br>windspeed_80m<br>windspeed_120m</th>
            <td>Instant</td>
            <td>km/h (mph, m/s, knots)</td>
            <td>Wind speed at 10, 40, 80 or 120 meters above ground. Wind speed on 10 meters is the standard level.
            </td>
          </tr>
          <tr>
            <th scope="row">winddirection_10m<br>winddirection_40m<br />winddirection_80m<br />winddirection_120m</th>
            <td>Instant</td>
            <td>°</td>
          ...
          <tr>
            ...
            <td>Preceding hour mean</td>
            <td>W/m²</td>
            <td>Direct solar radiation as average of the preceding hour on the horizontal plane and the normal plane (perpendicular to the sun). GEM does not offers diffuse and direct radiation directly. It is approximated based on <a href="https://www.ise.fraunhofer.de/content/dam/ise/de/documents/publications/conference-paper/36-eupvsec-2019/Guzman_5CV31.pdf" target="_blank">Razo, Müller Witwer</a></td>
          </tr>
          <tr>
            <th scope="row">diffuse_radiation</th>
            <td>Preceding hour mean</td>
            <td>W/m²</td>
            <td>Diffuse solar radiation as average of the preceding hour. GEM does not offers diffuse and direct radiation directly. It is approximated based on <a href="https://www.ise.fraunhofer.de/content/dam/ise/de/documents/publications/conference-paper/36-eupvsec-2019/Guzman_5CV31.pdf" target="_blank">Razo, Müller Witwer</a></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>Weather condition as a numeric code. Follow WMO weather interpretation codes. See table below for
              details. Weather code is calculated from cloud cover analysis, precipitation, snowfall, cape and gusts.</td>
          </tr>
          <tr>
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>%</td>
            <td>Cloud cover at the specified pressure level. GEM does not inlude parameterised cloud cover directly. It is approximated based on relative humidity
              using <a
