...
<div class="container my-6 grid gap-6 md:my-12 md:grid-cols-2 md:gap-12">
	<div>
		<h2 id="about" class="mb-3 text-3xl font-light md:text-5xl lg:mb-5">About</h2>
		...
		<p>
			...
			providing the source code, users can conduct detailed verifications of the weather data
		...
		<p>
			...
			improve and welcome any feedback or questions you may have. Please feel free to contact us at <a
				href="mailto:info@open-meteo.com">info@open-meteo.com</a
			>.
		</p>
	</div>
	<div>
		<h2 id="vision" class="mb-3 text-3xl font-light md:text-5xl lg:mb-5">Vision</h2>
		<p>
	...
	<div>
		<h2 id="contact" class="mb-3 text-3xl font-light md:text-5xl lg:mb-5">Contact</h2>
		<p>
